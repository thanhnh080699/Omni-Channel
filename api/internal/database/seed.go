...
var defaultPermissions = []models.Permission{
	...
	{Base: newBase("perm_channel_manage"), Code: "channel:manage", Resource: "channel", Action: "manage", Description: "Manage channel accounts and sharing"},
...
var defaultRoles = []models.Role{
	{
		...
		PermissionCodes: []string{"conversation:view_all", "conversation:assign", "message:send_team", "message:send_assigned", "attachment:view", "channel:manage", "admin:manage", "audit:view"},
	},
	{
...
var defaultChannels = []models.Channel{
	...
	{Base: newBase("ch_zalo_oa"), Code: "zalo_oa", Name: "Zalo OA", Kind: "zalo", OfficialAPIAvailable: true, Status: "enabled"},
